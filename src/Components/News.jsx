        ...
        <div className="container mx-auto flex justify-between items-center px-4">
            ...
            <div className="hidden lg:flex items-center space-x-8 text-white">
                <div className="flex items-center space-x-2">
                    <FaEnvelope /><span>demomazedhakale@gmail.com</span>
                </div>
                <div className="flex items-center space-x-4">
                    <FaPhone /><span>+91 0987654321</span>
            ...
            <nav className="flex items-center space-x-4">
                ...
                <Link to="/Pricing" className="bg-white text-black px-3 py-1 rounded hover:bg-gray-200">
                    Pricing
                </Link>
                <a href="#" className="bg-green-500 text-white px-3 py-1 rounded-md flex items-center space-x-1 shadow-md">
        ...
        <div className="bg-gray-100 min-h-screen flex flex-col">
            ...
            < div className="bg-gray-200 mx-6 sm:mx-6 lg:mx-10 rounded">
                <div className="max-w-4xl mx-auto px-6 py-2 text-sm text-gray-600">
                    <Link to="/" className="hover:underline">Home</Link> &gt;&gt; What&apos;s New
                </div>
            </div>
