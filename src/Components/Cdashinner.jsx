...
const CustomerDashboard = () => {
  ...
  const API_BASE_URL = "https://mazedakhale.in:3000/categories";
  const SUBCATEGORIES_API_URL = "https://mazedakhale.in:3000/subcategories";
  ...
  useEffect(() => {
    ...
    axios.get(`https://mazedakhale.in:3000/userdashboard/total-applied/${userId}`)
    ...
    axios.get(`https://mazedakhale.in:3000/userdashboard/total-completed/${userId}`)
      .then((res) => setCompletedCount(res.data.totalCompleted))
      .catch((err) => console.error("Error fetching total completed:", err));

    // Fetch category counts
    axios.get(`https://mazedakhale.in:3000/userdashboard/category-counts/${userId}`)
      .then((res) => {
    ...
    axios.get(`https://mazedakhale.in:3000/userdashboard/status-count/${userId}`)
      .then((res) => {
    ...
    axios.get("https://mazedakhale.in:3000/notifications/active")
  ...
  const fetchRequiredDocuments = async (categoryId, subcategoryId) => {
    try {
      const response = await axios.get(
        `https://mazedakhale.in:3000/required-documents/${categoryId}/${subcategoryId}`
      );
