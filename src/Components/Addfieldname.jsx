...
const FieldNames = () => {
  ...
  const fetchFields = async () => {
    try {
      const response = await axios.get("https://https://mazedakhale.in/field-names");
  ...
  const fetchSubcategories = async (categoryId) => {
    ...
    try {
      const response = await axios.get(`https://https://mazedakhale.in/subcategories/category/${categoryId}`);
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete.isConfirmed) {
      ...
      axios
        .delete(`https://https://mazedakhale.in/field-names/${id}`)
        .then(() => {
  ...
  const handleSave = async (id) => {
    try {
      await axios.patch(`https://https://mazedakhale.in/field-names/${id}`, { document_fields: editableField });
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://https://mazedakhale.in/field-names", formData);
