...
const DocumentTable = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get("https://mazedakhale.in/document-types");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingDoc) {
        ...
        await axios.put(
          `https://mazedakhale.in/document-types/${editingDoc.doc_type_id}`,
          formData
        );
      } else {
        // Add new document
        await axios.post("https://mazedakhale.in/document-types/", formData);
      }
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete.isConfirmed) {
      try {
        await axios.delete(`https://mazedakhale.in/document-types/${id}`);
        fetchDocuments(); // Refresh the document list
