            ...
            <div className="relative bg-white shadow-lg rounded-lg border border-gray-300 overflow-hidden">
                ...
                <div className="p-4 flex justify-end">
                    <button
                        ...
                        className={`px-4 py-2 rounded flex items-center gap-2 transition duration-200 ${contactInfos.length > 0
                ...
                <div className="p-6 overflow-x-auto">
                    <table className="w-full border border-[#776D6DA8] text-sm bg-white shadow-md rounded-md">
                        <thead className="bg-[#F58A3B14] border-b-2 border-[#776D6DA8]">
                            <tr>
                                {["ID", "Phone", "Email", "Address", "Actions"].map((header, index) => (
                        ...
                        <tbody>
                            {contactInfos.length > 0 ? (
                                contactInfos.map((info, index) => (
                                    ...
                                    >
                                        <td className="px-4 py-3 border border-[#776D6DA8] text-center">{info.id}</td>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-[400px]">
                        ...
                        <div className="flex justify-end gap-2">
                            <button onClick={() => setIsAdding(false)} className="px-4 py-2 bg-gray-400 text-white rounded">
                                Cancel
                            </button>
                            <button onClick={handleAdd} className="px-4 py-2 bg-orange-500 text-white rounded hover:bg-orange-600">
                                Save
                            </button>
                        </div>
                    </div>
