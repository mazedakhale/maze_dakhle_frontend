...
const Received = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(`http://13.201.37.154:3000/documents/assigned-list`)
            .then((response) => {
    ...
    const filteredDocuments = documents
        .filter((doc) => doc.status === "Sent") // Only include documents with status "Uploaded"
        .filter((doc) =>
                                ...
                                >
                                    ...
                                    <td className="border p-2">
                                        <div className="flex gap-2">
                                            {/* Complete Button */}
                                            <button
                                                onClick={() => handleUpdateStatus(doc.document_id, "Received")}
