    ...
    return (
        <div className="flex min-h-screen bg-[#f3f4f6]">
            ...
            <div className="flex-1 p-6 ml-[00%] pt-[70px]">
                {/* Top Navbar */}
                <div className="flex items-center justify-between bg-white text-gray px-4 py-2 shadow-[0_3px_2px_rgba(0,0,0,0.15)] fixed top-0 left-[20%] w-[80%] z-10 h-[73px]">          <span className="text-lg font-bold">Employee Dashboard</span>
