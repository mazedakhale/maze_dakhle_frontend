...
const DistributorList = () => {
    ...
    const apiUrl = "http://mazedakhale.in:3000/users/distributors";
    ...
    const handleUpdateDistributor = async (id) => {
        try {
            if (updatedPassword) {
                await axios.patch(`http://mazedakhale.in:3000/users/password/${id}`,
    ...
    const handleDeleteDistributor = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            ...
            try {
                await axios.delete(`http://mazedakhale.in:3000/users/delete/${id}`, { timeout: 30000 });
    ...
    const handleStatusChange = async (id, newStatus) => {
        try {
            ...
            await axios.patch(`http://mazedakhale.in:3000/users/status/${id}`,
                { status: newStatus },
                { timeout: 30000 }
            );
