...
const DistributorList = () => {
  ...
  return (
    <div className="ml-[300px] mt-[80px] p-6 max-w-[calc(100vw-320px)] overflow-x-hidden">
      <div className="relative bg-white shadow-lg rounded-lg border border-gray-300 overflow-hidden max-w-[95vw] mx-auto">
        {/* Header */}
                ...
                {distributors.length > 0 ? (
                  distributors.map((distributor, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 border border-[#776D6DA8] text-center whitespace-nowrap truncate max-w-[260px]">
                        <button
                          onClick={() =>
