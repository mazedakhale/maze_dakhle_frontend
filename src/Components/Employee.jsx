...
const Employee = () => {
    ...
    const fetchDocuments = async () => {
        setIsLoading(true);
        try {
            const response = await axios.get("https://mazedakhale.in/employee");
    ...
    const fetchCategories = async () => {
        try {
            const response = await axios.get("https://mazedakhale.in/categories");
    ...
    const fetchEmployees = async () => {
        try {
            ...
            const response = await axios.get("https://mazedakhale.in/users/employee");
    ...
    const handleCategoryChange = async (e) => {
        ...
        if (selectedCategoryId) {
            try {
                const response = await axios.get(`https://mazedakhale.in/subcategories/category/${selectedCategoryId}`);
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                ...
                await axios.delete(`https://mazedakhale.in/employee/${id}`);
    ...
    const handleEdit = async (groupedDoc) => {
        ...
        try {
            const response = await axios.get(`https://mazedakhale.in/subcategories/category/${groupedDoc.category_id}`);
            setSubcategories(response.data);
        } catch (error) {
            console.error("Error fetching subcategories:", error);
            setSubcategories([]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editId) {
                ...
                await axios.put(`https://mazedakhale.in/employee/${editId}`, dataToSend);
            } else {
                // For create, use the POST endpoint with the new API format
                await axios.post("https://mazedakhale.in/employee", dataToSend);
            }
