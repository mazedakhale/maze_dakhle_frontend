...
const Employee = () => {
    ...
    const fetchDocuments = async () => {
        setIsLoading(true);
        try {
            const response = await axios.get("http://13.201.37.154:3000/employee");
    ...
    const fetchEmployees = async () => {
        try {
            ...
            const response = await axios.get("http://13.201.37.154:3000/users/employee");
    ...
    const handleCategoryChange = async (e) => {
        ...
        if (selectedCategoryId) {
            try {
                const response = await axios.get(`http://13.201.37.154:3000/subcategories/category/${selectedCategoryId}`);
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                ...
                await axios.delete(`http://13.201.37.154:3000/employee/${id}`);
    ...
    const handleEdit = async (groupedDoc) => {
        ...
        try {
            const response = await axios.get(`http://13.201.37.154:3000/subcategories/category/${groupedDoc.category_id}`);
            setSubcategories(response.data);
        } catch (error) {
            console.error("Error fetching subcategories:", error);
            setSubcategories([]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editId) {
                ...
                await axios.put(`http://13.201.37.154:3000/employee/${editId}`, dataToSend);
            } else {
                // For create, use the POST endpoint with the new API format
                await axios.post("http://13.201.37.154:3000/employee", dataToSend);
            }
