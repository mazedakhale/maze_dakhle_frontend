...
const RequiredDocuments = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editId
        ? `https://vm.q1prh3wrjc0aw.ap-south-1.cs.amazonlightsail.com/required-documents/${editId}`
        : "https://vm.q1prh3wrjc0aw.ap-south-1.cs.amazonlightsail.com/required-documents";
