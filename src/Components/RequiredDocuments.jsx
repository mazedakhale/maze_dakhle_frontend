...
const RequiredDocuments = () => {
  ...
  const fetchDocuments = async () => {
    try {
      const response = await axios.get("http://mazedakhale.in:3000/required-documents");
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete.isConfirmed) {
      try {
        await axios.delete(`http://mazedakhale.in:3000/required-documents/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editId
        ? `http://mazedakhale.in:3000/required-documents/${editId}`
        : "http://mazedakhale.in:3000/required-documents";
