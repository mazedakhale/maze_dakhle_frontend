...
const CustomerList = () => {
    ...
    const apiUrl = "https://mazedakhale.in:3000/users/customers";
    ...
    const handleUpdateCustomer = async (id) => {
        try {
            if (updatedPassword) {
                await axios.patch(`https://mazedakhale.in:3000/users/password/${id}`, { newPassword: updatedPassword });
            }
    ...
    const handleDeleteCustomer = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            ...
            try {
                await axios.delete(`https://mazedakhale.in:3000/users/delete/${id}`);
    ...
    const handleStatusChange = async (id, newStatus) => {
        try {
            ...
            await axios.patch(`https://mazedakhale.in:3000/users/status/${id}`, { status: newStatus });
