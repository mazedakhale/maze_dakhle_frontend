...
const EmployeeDocumentList = () => {
        ...
        try {
            ...
            if (userRole === "Admin" || userRole === "Employee") {
                ...
                const response = await axios.get(
                    `https://https://mazedakhale.in/documents/category-docs/${categoryId}/${subcategoryId}/${userId}`
                );
    ...
    const handleViewCertificate = async (documentId) => {
        try {
            const response = await axios.get(`https://https://mazedakhale.in/certificates/by-document/${documentId}`);
