...
const EmployeeDocumentList = () => {
        ...
        try {
            ...
            if (userRole === "Admin" || userRole === "Employee") {
                ...
                const response = await axios.get(
                    `http://mazedakhale.in:3000/documents/category-docs/${categoryId}/${subcategoryId}/${userId}`
                );
    ...
    const handleViewCertificate = async (documentId) => {
        try {
            const response = await axios.get(`http://mazedakhale.in:3000/certificates/by-document/${documentId}`);
