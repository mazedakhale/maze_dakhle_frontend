...
const ErrorRequests = () => {
  ...
  const fetchErrorRequests = async (distributorId) => {
    try {
      ...
      const response = await axios.get(
        `https://mazedakhale.inrequest-errors/distributor/${distributorId}`
      );
  ...
  const fetchCertificates = async () => {
    try {
      ...
      const response = await axios.get("https://mazedakhale.incertificates");
  ...
  const handleViewCertificate = async (documentId) => {
    ...
    try {
      ...
      const response = await axios.get(`https://mazedakhale.incertificates/${certificateId}`);
  ...
  const handleDownloadCertificate = async (documentId, requestName) => {
    try {
      const response = await axios.get(
        `https://mazedakhale.indownload-certificate/${documentId}`,
        {
