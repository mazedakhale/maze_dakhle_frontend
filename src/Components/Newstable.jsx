...
const NewsTable = () => {
    ...
    const handleDelete = async id => {
        const result = await Swal.fire({
            title: "Are you sure?",
            text: "This news item will be deleted permanently!",
            icon: "warning",
                ...
                <div className="p-6 overflow-x-auto">
                    <table className="w-full border border-gray-300 text-sm bg-white shadow-md rounded-md">
                        <thead className="bg-orange-100 border-b-2 border-orange-400">
                            <tr>
                                {["ID", "Description", "Created At", "Actions"].map((header, idx) => (
                                    <th
                                        key={idx}
                        ...
                        <tbody>
                            {newsList.length > 0 ? (
                                newsList.map((item, idx) => (
                                    ...
                                    >
                                        <td className="px-4 py-3 border border-gray-300 text-center">{item.id}</td>
                                ...
                                <tr>
                                    <td colSpan="4" className="px-4 py-3 border border-gray-300 text-center text-gray-500">
                                        No news items found.
                                    </td>
                                </tr>
                            )}
