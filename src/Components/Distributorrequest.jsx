...
const ErrorRequests = () => {
  ...
  const fetchErrorRequests = async (distributorId) => {
    try {
      ...
      const response = await axios.get(
        ` https://mazedakhale.in/request-errors/distributor/${distributorId}`
      );
  ...
  const handleRejectStatus = async (requestId) => {
    ...
    try {
      ...
      const response = await axios.patch(` https://mazedakhale.in/request-errors/update-status/${requestId}`, {
        request_status: "Distributor Rejected",
  ...
  const handleUploadCertificate = async (documentId, requestId) => {
    ...
    try {
      const uploadResponse = await axios.patch(
        `https://mazedakhale.in/certificates/update/${documentId}`,
        formData,
        {
          headers: {
      ...
      const updateStatusResponse = await axios.patch(
        `https://mazedakhale.in/request-errors/update-status/${requestId}`,
